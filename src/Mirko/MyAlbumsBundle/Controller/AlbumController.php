...
use Mirko\MyAlbumsBundle\Entity\Album;
use Mirko\MyAlbumsBundle\Form\AlbumType;
...
class AlbumController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MirkoMyAlbumsBundle:Album')->findAll();
     ...
     * @Method("POST")
     * @Template("MirkoMyAlbumsBundle:Album:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MirkoMyAlbumsBundle:Album')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MirkoMyAlbumsBundle:Album:edit.html.twig")
     */
